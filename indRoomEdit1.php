...
if(isset($_POST['sell_particulars']) && isset($_POST['roomAddress']) && isset($_POST['name'])){
        if(!empty($_POST['sell_particulars']) &&!empty($_POST['roomAddress']) && !empty($_POST['name'])){
			
			//echo "panju";
			$r=$_POST['sell_particulars'];
			$q=$_POST['roomAddress'];
			$name=$_POST['name'];
			//$image=$_POST['image'];
			
			
			$query="UPDATE bs SET name='$name', roomAddress='$q', sell_particulars='$r' WHERE bid='{$_SESSION['bid']}' ";
...
<form action="indRoomEdit1.php" method="POST">
                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="sell_particulars" value="<?php echo $row['rental_particulars']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
