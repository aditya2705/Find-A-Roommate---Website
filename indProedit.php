...
if(isset($_POST['language']) && isset($_POST['culture']) && isset($_POST['qualification']) && isset($_POST['maritalStatus'])){
        if(!empty($_POST['language']) && !empty($_POST['culture']) &&!empty($_POST['qualification']) && !empty($_POST['maritalStatus'])){
			...
			$query="UPDATE roomates SET qualification='$q', culture='$c', maritalStatus='$ms', language='$l' WHERE rid='{$_SESSION['rid']}' ";
...
<head>
	...
	<link href="css/indProedit.css" rel="stylesheet">
...
<form action="indProedit.php" method="POST">
...
<div class="col-lg-12">
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Qualification</a>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="qualification" value="<?php echo $row['qualification']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Marital Status</a>
                            </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="maritalStatus" value="<?php echo $row['maritalStatus']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Culture</a>
                            </h4>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="culture" value="<?php echo $row['culture']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Language</a>
                            </h4>
                        </div>
                        <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="language" value="<?php echo $row['language']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
