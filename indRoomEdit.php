...
if(isset($_POST['clauses']) && isset($_POST['rental_particulars']) && isset($_POST['roomAddress']) && isset($_POST['name'])){
        if(!empty($_POST['clauses']) && !empty($_POST['rental_particulars']) &&!empty($_POST['roomAddress']) && !empty($_POST['name'])){
			
			//echo "panju";
			$r=$_POST['rental_particulars'];
			$c=$_POST['clauses'];
			$q=$_POST['roomAddress'];
			$name=$_POST['name'];
			//$image=$_POST['image'];
			...
			$query="UPDATE rent SET name='$name', roomAddress='$q', rental_particulars='$r', clauses='$c' WHERE oid='{$_SESSION['oid']}' ";
...
<link href="css/indRoomEdit.css" rel="stylesheet">
	<script>
...
<form action="indRoomEdit.php" method="POST">
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="name" value="<?php echo $row['name']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="roomAddress" value="<?php echo $row['roomAddress']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="rental_particulars" value="<?php echo $row['rental_particulars']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                                <input type="text" class="area" id="editableBox" name="clauses" value="<?php echo $row['clauses']; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
