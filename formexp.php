...
<script>
	...
	{
		$.post("getRoom1.php",{partial:value},function(data){
        $("#results").html(data);
		});
	}
	</script>
      ...
      <ul id="sidebar_menu" class="sidebar-nav">
		...
		<li>
		  ...
		  <div id="filter"> 
                        ...
                        <input type="checkbox" id="g1" name="g1" value="male"><span id="genderStyle" style="padding-right:7px">Male</span>
						<input type="checkbox" id="g2" name="g2" value="female"><span id="genderStyle" style="padding-right:67px">Female</span>
						
                        <br/><br/>
                        <span>Apartment Type:</span><br/>
                        <input type="checkbox" id="p1" name="p1" value="student"><span id="genderStyle" style="padding-right:15px">Student</span>
						<input type="checkbox" id="p2" name="p2" value="teacher"><span id="genderStyle" style="padding-right:15px">Teacher</span>
                        <input type="checkbox" id="p3" name="p3" value="engineer"><span id="genderStyle" style="padding-right:15px">Engineer</span><br/><br/> 
                        <input type="checkbox" name="p4"id="p4" value="doctor"><span id="genderStyle" style="padding-right:15px">Doctor</span>
                        <input type="checkbox" name="p4"id="p4" value="other"><span id="genderStyle" style="padding-right:15px">Other</span>
                        </div>
                        </br>
                        </br>
